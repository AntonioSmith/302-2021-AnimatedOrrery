...
public class Planet : MonoBehaviour
{
    ...
    // [Range(-10, 10)] public float revolutionSpeed = 0; // Allows a range of speed for the planets between -10 and 10
    ...
    public void RevolveAround()
    {
        ...
        */
        ...
        offset.y = Mathf.Tan(age) * Yradius;
